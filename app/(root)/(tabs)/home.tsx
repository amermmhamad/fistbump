...
// Mock Data
const MOCK_POSTS = [
  { id: '1', title: 'Launching our new feature next week!', date: '2 hours ago', thumbnail: null },
  { id: '2', title: 'Great team meeting today. Big things coming.', date: '1 day ago', thumbnail: null },
  { id: '3', title: 'Reflecting on Q1 goals.', date: '3 days ago', thumbnail: null },
  { id: '4', title: 'Join our webinar on Friday.', date: '1 week ago', thumbnail: null },
];
...
const PostCard = ({ item }: { item: typeof MOCK_POSTS[0] }) => (
  <View className="bg-white p-4 rounded-xl shadow-sm mb-4 mx-2 flex-1 border border-slate-100">
    ...
    <Text className="font-semibold text-slate-800 mb-1 line-clamp-2">{item.title}</Text>
      ...
      <ScrollView className="flex-1 px-4 pt-2">
        ...
        <View className="flex-row items-center justify-between mb-6 mt-2">
          <View className="flex-row items-center space-x-3">
            ...
            <View>
              <Text className="text-lg font-bold text-slate-900">Alex Johnson</Text>
              <Text className="text-sm text-slate-500">Acme Corp</Text>
            </View>
          </View>
        ...
        <View className="mb-8">
          ...
          <TouchableOpacity className="bg-indigo-600 p-4 rounded-xl flex-row items-center justify-center shadow-md active:bg-indigo-700">
             <Ionicons name="sparkles" size={20} color="white" style={{ marginRight: 8 }} />
             <Text className="text-white font-bold text-lg">Create New Post with AI</Text>
          </TouchableOpacity>
        </View>
