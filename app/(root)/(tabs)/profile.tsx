    ...
    <SafeAreaView className="flex-1 bg-slate-50">
      ...
      <ScrollView className="flex-1">
        <View className="items-center py-8 bg-white border-b border-slate-100 mb-6">
            ...
            <Text className="text-slate-500">Fist Bump • amer@getfistbumps.com</Text>
        </View>

        <View className="px-4">
            <Text className="text-sm font-bold text-slate-400 uppercase mb-3 ml-1">Integrations</Text>
            ...
            <Text className="text-sm font-bold text-slate-400 uppercase mb-3 ml-1 mt-6">AI Settings</Text>
            ...
            />
             ...
             <Text className="text-sm font-bold text-slate-400 uppercase mb-3 ml-1 mt-6">Account</Text>
             <SettingItem 
