    ...
    <SafeAreaView className="flex-1 bg-slate-50 justify-center items-center">
      ...
      <View className="w-full max-w-md px-8">
        <View className="mb-10 items-center">
          <Image
            source={require("../assets/images/fist-bump-logo.png")}
            className="w-40 h-40"
            resizeMode="contain"
          />
          ...
          <Text className="text-slate-500 mt-2">
            Sign in to continue to Fistbump
          </Text>
        </View>
        ...
        <View className="space-y-3">
          ...
          <TouchableOpacity
            ...
            className="w-full bg-white border border-slate-200 py-3 rounded-xl items-center flex-row justify-center space-x-2 mt-2"
          >
